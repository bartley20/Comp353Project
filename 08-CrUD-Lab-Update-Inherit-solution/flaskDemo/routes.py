...
from flaskDemo.forms import RegistrationForm, CreateForm, LoginForm, UpdateAccountForm, PostForm, DeptForm,DeptUpdateForm
...
def home():
    ...
    results2 = Project.query.join(Works_On, Project.pnumber == Works_On.pno)\
        .add_columns(Project.pname).join(Employee, Works_On.essn == Employee.ssn)\
            .add_columns(Employee.fname,Works_On.essn,Works_On.pno,Employee.lname)
